...
/* HUB descriptor */
UNCACHED_BUFFER static uint8_t usb_ghhub_Descriptor[USB_CONFIGSIZE];
/* HUB status data */
UNCACHED_BUFFER static USB_HUB_STATUS_t usb_ghhub_Status[USB_MAXDEVADDR + 1u];
/* HUB receive data */
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_RegisterCallback
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_GetProductIdStr
 *
...
static void R_USB_HHUB_Close(uint16_t hubaddr)
{
    ...
    if( usb_shhub_Info[hubaddr].pipe_id != 0 )
    {
        ...
        usb_shhub_Info[hubaddr].pipe_id = 0;
    }
    ...
    usb_shhub_Info[hubaddr].up_addr    = 0;
    usb_shhub_Info[hubaddr].up_port    = 0;
    usb_shhub_Info[hubaddr].port_num   = 0;
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_Suspend
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_Resume
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_enumeration
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_InitDownPort
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_PortAttach
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_event
 *
...
static void R_USB_HHUB_event(USB_UTR_t *mess)
{
    ...
    case USB_SEQ_1:        /* Request Result Check & Request */
        ...
        else
        {
            ...
            {
                /* Don't have a valid value in port_clr_feature_type so don't execute R_USB_HHUB_PortClrFeature() */
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_check_class
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_trans_start
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_GetHubDescriptor
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_GetStatus
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_PortSetFeature
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_PortClrFeature
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_trans_complete
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_class_request_product_id_complete
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_class_request_complete
 *
 *  Description:    Hub class check result
 *
 *  Parameters:     USB_UTR_t *utr : Transfer Request Pointer
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_new_connect
 *
...
static void R_USB_HHUB_new_connect(void)
{
    ...
    for( i = (USB_HUBDPADDR); i <= USB_MAXDEVADDR; i++ )
    {
        /* Protect Overlap */
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_GetCnnDevaddr
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_port_detach
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_selective_detach
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_SpecifiedPath
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_HHUB_SpecifiedPathWait
 *
 *  Description:    Next Process Selector
 *
 *  Parameters:     uint16_t result        : utr result
