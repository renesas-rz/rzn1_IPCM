...
{
    ((uint8_t *) buf)[1] = (uint8_t) USB_DRIVER_MAJOR_VERSION_NUMBER;
    ((uint8_t *) buf)[0] = (uint8_t) USB_DRIVER_MAJOR_VERSION_NUMBER;
}
/***********************************************************************************************************************
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USBh_GetVersion
 *
 *  Return Value:   None
 *
 *  Parameters:     None
...
{
    ((uint8_t *) buf)[1] = (uint8_t) USBH_DRIVER_MAJOR_VERSION_NUMBER;
    ((uint8_t *) buf)[0] = (uint8_t) USBH_DRIVER_MINOR_VERSION_NUMBER;
}
/***********************************************************************************************************************
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_USB_ConvertUnicodeStrDscrToAsciiStr
 *
