 ...
 **********************************************************************************************************************/
/* Variable */
static USBH_DRIVER_STATE_E usbh_driver_state = USBH_DRIVER_STATE_UNINITIALISED;
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_usb_hstd_AhbPciBridgeInit
 *
...
ER_RET R_USBh_Init(void)
{
    ...
    if (USBH_DRIVER_STATE_INITIALISED == usbh_driver_state)
    {
        ret_val = ER_INVAL;
    }
    else
    {
        ...
        if (ER_OK == ret_val)
        {
            usbh_driver_state = USBH_DRIVER_STATE_INITIALISED;
        }
    }
...
/***********************************************************************************************************************
 *
 * Function Name:   R_USBh_Uninit
 *
 * Description  :   Uninitialises the USBh driver
 *
 * Arguments    :   None
 *
 * Return Value :   Error status
 *
 **********************************************************************************************************************/
ER_RET R_USBh_Uninit(void)
{
    ER_RET ret_val = ER_OK;

    if (USBH_DRIVER_STATE_UNINITIALISED == usbh_driver_state)
    {
        ret_val = ER_INVAL;
    }
    else
    {
        ...
        usbh_driver_state = USBH_DRIVER_STATE_UNINITIALISED;
    }

    return ret_val;
}
/***********************************************************************************************************************
 End of function R_USBh_Uninit
 **********************************************************************************************************************/

/***********************************************************************************************************************
 *
 *  Function Name:  R_USBh_PollTask
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_usb_hstd_SetPipe
 *
 *  Description:    SetPipe
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_usb_hstd_GetPipeID
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_usb_hstd_ClearPipe
 *
...
/***********************************************************************************************************************
 *
 *  Function Name:  R_usb_cstd_DelayXms
 *
