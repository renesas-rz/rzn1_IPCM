 ...
 **********************************************************************************************************************/
UNCACHED_BUFFER USB_HCDREG_t    usb_ghstd_DeviceDrv[USB_MAXDEVADDR + 1u];       /* Device driver (registration) */
UNCACHED_BUFFER uint16_t        usb_ghstd_MgrMode[USB_ROOTPORT_MAX];            /* Manager mode */
UNCACHED_BUFFER uint16_t        usb_ghstd_DeviceAddr;                           /* Device address */
UNCACHED_BUFFER uint16_t        usb_ghstd_DeviceSpeed;                          /* reset handshake result */
UNCACHED_BUFFER uint16_t        usb_ghstd_DeviceNum;                            /* Device driver number */
UNCACHED_BUFFER uint16_t        usb_ghstd_CheckEnuResult;
...
UNCACHED_BUFFER static uint16_t        usb_ghstd_EnumSeq;   /* Enumeration request */
UNCACHED_BUFFER static uint16_t        usb_ghstd_DeviceDescriptor[USB_DEVICESIZE / 2u];
UNCACHED_BUFFER static uint16_t        usb_ghstd_ConfigurationDescriptor[USB_CONFIGSIZE / 2u];
UNCACHED_BUFFER static uint16_t        usb_ghstd_LangId;
UNCACHED_BUFFER static uint8_t         usb_ghstd_ClassData[CLSDATASIZE];
UNCACHED_BUFFER static USB_UTR_t       usb_ghstd_ClassControl;
UNCACHED_BUFFER static USB_SETUP_t     usb_ghstd_ClassRequest; /* bRequest/wValue/wIndex/wLength/Data */
...
/***********************************************************************************************************************
 *
 *  Function Name:  usb_hstd_SetLangId
 *
 *  Description:    Set Language ID of current device being enumerated
