...
typedef enum
{
    USBH_DRIVER_STATE_UNINITIALISED = 0,    /*!< Driver uninitialised */
    USBH_DRIVER_STATE_INITIALISED,          /*!< Driver initialised */
} USBH_DRIVER_STATE_E;
...
#define USBH_DRIVER_MINOR_VERSION_NUMBER    (3)
...
#define USB_ROOTPORT_MAX                    1       /* Maximum number of ports of EHCI and OHCI. Please also see USB_EHCI_MAXROOTPORTS and USB_OHCI_MAXROOTPORTS */
