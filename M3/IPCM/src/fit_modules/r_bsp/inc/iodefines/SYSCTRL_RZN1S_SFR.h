...
typedef struct
{
  ...
  union                                            /* Offset=0x0018 : SYSSTAT */
  {
    ...
    struct
    {
      __I  unsigned long   CA7_STANDBYWFE:1;                           /* [0] */
      __I  unsigned long   :1;                                         /* [1] */
      __I  unsigned long   CA7_STANDBYWFI:1;                           /* [2] */
  ...
  union                                            /* Offset=0x0064 : PWRCTRL_QSPI2DIV */
  {
    __IO unsigned long     LONG;
    struct
    {
  ...
  union                                            /* Offset=0x0090 : PWRCTRL_QSPI2 */
  {
    __IO unsigned long     LONG;
    struct
    {
  ...
  union                                            /* Offset=0x0098 : PWRSTAT_QSPI2 */
  {
    __I  unsigned long     LONG;
    struct
    {
  ...
  union                                            /* Offset=0x00A8 : RSTSTAT */
  {
    ...
    struct
    {
      ...
      __IO unsigned long   WDA7RST_ST:1;                               /* [1] */
  ...
  union                                            /* Offset=0x0120 : RSTEN */
  {
    ...
    struct
    {
      ...
      __IO unsigned long   WDA7RST_EN:1;                               /* [1] */
      __IO unsigned long   :1;                                         /* [2] */
  ...
  union                                            /* Offset=0x0198 : RSTCTRL */
  {
    ...
    {
      __IO unsigned long   :1;                                         /* [0] */
      __IO unsigned long   WDA7RST_REQ:1;                              /* [1] */
      __IO unsigned long   :1;                                         /* [2] */
