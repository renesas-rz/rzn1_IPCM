 ...
 * FILE         :  r_gpio_rzn1d.h
 * Description  :  Specifics for the r_gpio_rzn1d driver for the RZN1D.
 *
 * (C) Copyright Renesas Electronics Europe Ltd. 2019. All Rights Reserved
 **********************************************************************************************************************/

#ifndef R_GPIO_RZN1D_H__
#define R_GPIO_RZN1D_H__
...
#include "platform.h"
#if defined(BSP_MCU_RZN1D)  //Prevents the compiler from finding multiple definitions of constant in this file.
...
#if (BSP_PACKAGE_PINS == 400)
#define GPIO_INFO_NUM_PORTS             (6u)
#define GPIO_INFO_NUM_PINS              (170u)
#elif (BSP_PACKAGE_PINS == 324)
#define GPIO_INFO_NUM_PORTS             (5u)
#define GPIO_INFO_NUM_PINS              (132u)
#else
...
#define GPIO_MAX_PORT (GPIO_PORT_3B)
#define GPIO_MAX_PIN (GPIO_PORT_3B_PIN_09)
...
typedef enum
{
    ...
    GPIO_PORT_3B_PIN_00 = 0x3B00,
    GPIO_PORT_3B_PIN_01 = 0x3B01,
    GPIO_PORT_3B_PIN_02 = 0x3B02,
    GPIO_PORT_3B_PIN_03 = 0x3B03,
    GPIO_PORT_3B_PIN_04 = 0x3B04,
    GPIO_PORT_3B_PIN_05 = 0x3B05,
    GPIO_PORT_3B_PIN_06 = 0x3B06,
    GPIO_PORT_3B_PIN_07 = 0x3B07,
    GPIO_PORT_3B_PIN_08 = 0x3B08,
    GPIO_PORT_3B_PIN_09 = 0x3B09,
}gpio_port_pin_t;

#elif (BSP_PACKAGE_PINS == 324)

#define GPIO_MAX_PORT (GPIO_PORT_3A)
#define GPIO_MAX_PIN (GPIO_PORT_3A_PIN_27)
...
#define PORT_1B_SIZE (17)
#define PORT_2A_SIZE (32)
#define PORT_2B_SIZE (32)
#define PORT_3A_SIZE (28)
#define PORT_3B_SIZE (0)

#define PORT_1A_MASK (0xFFFFFC00)
#define PORT_1B_MASK (0xFFFFC000)
#define PORT_2A_MASK (0xFFFFFFFF)
#define PORT_2B_MASK (0xFFFFFFFF)
#define PORT_3A_MASK (0x0FFFFFFF)
#define PORT_3B_MASK (0x00000000)
