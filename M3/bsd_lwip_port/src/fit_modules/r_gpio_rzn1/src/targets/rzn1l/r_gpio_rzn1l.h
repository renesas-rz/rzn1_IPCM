 ...
 * FILE         :  r_gpio_rzn1l.h
 * Description  :  Specifics for the r_gpio_rzn1d driver for the RZN1L.
 *
 * (C) Copyright Renesas Electronics Europe Ltd. 2019. All Rights Reserved
 **********************************************************************************************************************/

#ifndef R_GPIO_RZN1L_H__
#define R_GPIO_RZN1L_H__
...
#include "platform.h"
#if defined(BSP_MCU_RZN1L)  //Prevents the compiler from finding multiple definitions of constant in this file.
...
#define PORT_1A_MASK (0xFFFF801F)
#define PORT_1B_MASK (0xFFE0007F)
#define PORT_2A_MASK (0x1FFFFFFF)
#define PORT_2B_MASK (0x03FFFFFF)
#define PORT_3A_MASK (0x00000000)
