...
/***********************************************************************************************************************
 ...
 Return value    : none
 **********************************************************************************************************************/
void R_usb_pcdc_ReceiveData(uint8_t *Table, uint32_t size,
...
/***********************************************************************************************************************
 ...
 Arguments       : uint16_t  serial_state   ; State of Serial port
                 : USB_CB_t  complete       ; Pointer to Callback function
 Return value    : none
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 ...
 Arguments       : USB_REQUEST_t *preq  ; Class request information
