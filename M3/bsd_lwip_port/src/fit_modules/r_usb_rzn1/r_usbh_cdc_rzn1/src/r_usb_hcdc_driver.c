...
static uint8_t     usb_ghcdc_ClassRequestData[USB_HCDC_TR_DATA_SIZE];   /* CDC Class Request transfer Data */
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hcdc_send_message
 *
 ...
 *
 **********************************************************************************************************************/
USB_ER_t usb_hcdc_send_message(uint16_t msginfo, uint16_t pipe_id,
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hcdc_class_request_process
 *
