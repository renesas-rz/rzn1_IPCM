 ...
 * FILE         :   r_usbf_core.c
 * Description  :   USB function signal control code
...
void usb_pstd_AttachProcess(void)
{
    ...
    systimer_delay(15000); /* Delay 15 msecs */
...
static void usb_pstd_GetDescriptor1(void)
{
    ...
    if (USB_DEVICE == usb_gpstd_ReqTypeRecip)
    {
        ...
        case USB_DT_DEVICE_QUALIFIER:
            if ((true == R_USBHAL_IsHighSpeed()) && (0 == usb_gpstd_ReqIndex)
                    && (0 == idx))
            {
