...
/***********************************************************************************************************************
 * Function Name :   usb_get_major_version_num
 **********************************************************************************************************************/
/*!
 * @brief    Returns major version number of USB function basic driver
 * @details  Returns major version number
 * @param    void
 * @retval   Major version number
 **********************************************************************************************************************/
uint8_t R_usb_pstd_get_major_version_num(void)
{
    return (uint8_t) USB_DRIVER_MAJOR_VERSION_NUMBER;
}
/***********************************************************************************************************************
 End of function R_usb_pstd_get_major_version_num
 **********************************************************************************************************************/

/***********************************************************************************************************************
 * Function Name :   usb_get_minor_version_num
 **********************************************************************************************************************/
/*!
 * @brief    Returns minor version number of USB function basic driver
 * @details  Returns minor version number
 * @param    void
 * @retval   Minor version number
 **********************************************************************************************************************/
uint8_t R_usb_pstd_get_minor_version_num(void)
{
    return (uint8_t) USB_DRIVER_MINOR_VERSION_NUMBER;
}
/***********************************************************************************************************************
 End of function R_usb_pstd_get_minor_version_num
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 ...
 Description     : Initiate data transfer for a Pipe
...
/***********************************************************************************************************************
 ...
 Arguments       : uint16_t status   : Control transfer status.
 Return value    : none
 **********************************************************************************************************************/
