...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciMakeTransferRequest
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciSetAsyncQh
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciTransferEndQh
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciTransferEndItd
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciTransferEndSitd
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciMakeCntrolBulkInterruptRequest
 *
 *  Description:    Make Transfer Request
 *
 *  Parameters:     USB_HCI_TR_REQ *tr_req    ; Transfer Request Information
...
static void usb_hstd_EhciMakeCntrolBulkInterruptRequest( USB_HCI_TR_REQ *tr_req )
{
    ...
    USB_EHCI_QTD    *qtd_head;
    USB_EHCI_QTD    *qtd_end;
    uint32_t        data_pid;
    uint32_t        setup_pid;
    uint32_t        data_ioc;
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciMakeIsochronousRequest
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciSetPeriodicQh
 *
...
/***********************************************************************************************************************
 *
 *  Function:       void usb_hstd_EhciStartPeriodicQh( USB_EHCI_QH *qh )
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciStartItd
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciInitSitd
 *
...
/***********************************************************************************************************************
 *
 *  Function:       usb_hstd_EhciStartSitd
 *
