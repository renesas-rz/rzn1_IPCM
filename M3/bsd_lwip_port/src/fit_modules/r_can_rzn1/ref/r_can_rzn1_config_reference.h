 ...
 * FILE         :  r_can_rzn1_config_reference.h
 * Description  :  Configures the CAN module.
 *
 * (C) Copyright Renesas Electronics Europe Ltd. 2019. All Rights Reserved
 **********************************************************************************************************************/

#ifndef CAN_RZN1_CONFIG_HEADER_FILE
#define CAN_RZN1_CONFIG_HEADER_FILE
...
#define CAN_CHAN1_DEFAULT_BITRATE               (CAN_BR_1000_KBITS)
#define CAN_CHAN2_DEFAULT_BITRATE               (CAN_BR_1000_KBITS)

#define CAN_DEFAULT_INT_PRIORITY                (9u)

#endif /* CAN_RZN1_CONFIG_HEADER_FILE */
