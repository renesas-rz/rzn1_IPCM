...
/***********************************************************************************************************************
 *
 *  Function:       dma_get_major_version_num
 *
 *  Return value:   DMA driver Major version number
 *
 *  Parameters:     None
 *
 *  Description:    Gets the DMA driver's Major version number
 *
 **********************************************************************************************************************/
uint8_t dma_get_major_version_num (void)
{
    return (uint8_t) DMA_DRIVER_MAJOR_VERSION_NUMBER;
}
/***********************************************************************************************************************
 End of function dma_get_major_version_num
 **********************************************************************************************************************/

/***********************************************************************************************************************
 *
 *  Function:       dma_get_minor_version_num
 *
 *  Return value:   DMA driver Minor version number
 *
 *  Parameters:     None
 *
 *  Description:    Gets the DMA driver's Minor version number
 *
 **********************************************************************************************************************/
uint8_t dma_get_minor_version_num (void)
{
    return (uint8_t) DMA_DRIVER_MINOR_VERSION_NUMBER;
}
/***********************************************************************************************************************
 End of function dma_get_minor_version_num
 **********************************************************************************************************************/

/***********************************************************************************************************************
 *
 *  Function:       dma_setcallback
 *
 *  Return value:   None.
 *
...
static void handle_dma_isr (IRQn_Type *irq_num_ptr)
{
    ...
    if (MAX_DMAC > dmac_number)
    {
        for (chan = 0; chan < MAX_DMA_CHAN; chan++)
        {
            ...
            DMACBaseAddress[dmac_number]->ClearErr.LONGLONG = 0x01 << chan;
