 ...
 * FILE         :  r_gmac_rzn1_config.h
 * Description  :  Configures the GMAC module.
 *
 * (C) Copyright Renesas Electronics Europe Ltd. 2019. All Rights Reserved
 **********************************************************************************************************************/

#ifndef GMAC_RZN1_CONFIG_HEADER_FILE
#define GMAC_RZN1_CONFIG_HEADER_FILE
...
#define GMAC_DEFAULT_INT_PRIORITY           (7u)

#endif /* GMAC_RZN1_CONFIG_HEADER_FILE */
