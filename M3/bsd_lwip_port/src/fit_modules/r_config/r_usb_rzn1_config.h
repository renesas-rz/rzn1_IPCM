 ...
 * FILE         :  r_usb_rzn1_config.h
 * Description  :  Configures the USB module.
 *
 * (C) Copyright Renesas Electronics Europe Ltd. 2019. All Rights Reserved
 **********************************************************************************************************************/
#ifndef USB_RZN1_CONFIG_HEADER_FILE
#define USB_RZN1_CONFIG_HEADER_FILE
...
#define MAX_USBF_CHANNELS   (1)

#endif /* USB_RZN1_CONFIG_HEADER_FILE */
